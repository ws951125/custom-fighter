...
WU5 Gallery read-side slice was implemented on PR #212 (`feat/v2-7-wu5-creator-gallery-browse`); original latest HEAD `d560192cd59320c29b5add24db6cfaee44270750` completed CI #638 SUCCESS, with Chromium and Edge Gallery unavailable/browse/detail/exact-revision/SHA/import/tamper regression. PR #211 documentation sync is now merged at `1044e341231d2cdda9c7b00dad28f90310f10388`; PR #212 has been reconciled with that main update without merging its UI. The new reconciliation merge commit must have its own exact-head CI before any #212 merge. Separate preview and subjective Gallery UX acceptance remain pending. Live Supabase persistence/Auth, production publish and cross-user end-to-end acceptance still require explicit no-cost provider authorization. V2 remains 75% (6/8).
