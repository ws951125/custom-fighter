...
Validate **V2-6 Work Unit 1 — session/lobby + authority admission contract**. After WU1 validation/merge, continue to **WU2 — server-side package authority admission**.
