...
- **Validation:** Pending latest-head PR #180 CI after test-harness hardening; Windows Native/Godot/backend/Chromium had already passed before these harness-only changes.
- **Status:** Fix implemented; latest-head cross-browser validation pending
