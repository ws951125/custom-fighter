...
Work Unit 4 — **durable free-tier persistence + publisher identity adapter checkpoint implemented; external activation and server-side package-validator parity still pending**:
