...
- Exact-main CI #525 (`35708039807`) is running on the merge revision.
...
- Branch `feat/v2-4-wu6-single-player-acceptance` carries the acceptance-only change; required PR CI and deployed exact-main production validation remain pending.
