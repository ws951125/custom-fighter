...
- PR #212 remains OPEN and unmerged. Production Pages does not expose WU5 Gallery; manual UI/UX acceptance and future preview remain gated. Publish/Auth, durable production catalogue and cross-user acceptance are not claimed complete; V2 stays 75% (6/8).
