...
func _preview_family_cast_state() -> Variant:
	...
	match preview_slot:
		...
		"skill_8":
			return _controller_cast_state("TrapSkillController")
		"skill_9":
			return _controller_cast_state("AuraSkillController")
		"skill_10":
			return _controller_cast_state("TeleportSkillController")
		"skill_11":
			return _controller_cast_state("CounterSkillController")
		"skill_12":
			return _controller_cast_state("GrabSkillController")
		"skill_13":
			return _controller_cast_state("SummonSkillController")
	return null
