...
func _set_web_state() -> void:
	...
	JavaScriptBridge.eval(
		...
		"document.documentElement.dataset.playerCharacterSkill10=%s;" % JSON.stringify(player_character.skill_id_for_slot("skill_10")) +
		"document.documentElement.dataset.playerRuntimeSkill10=%s;" % JSON.stringify(str(player_runtime_skill_ids.get("skill_10", ""))) +
		"document.documentElement.dataset.playerRuntimeSkill10Type=%s;" % JSON.stringify(str(player_runtime_skill_types.get("skill_10", ""))) +
		"document.documentElement.dataset.playerRuntimeSkill10Source=%s;" % JSON.stringify(str(player_runtime_skill_sources.get("skill_10", ""))) +
		"document.documentElement.dataset.playerCharacterSkill11=%s;" % JSON.stringify(player_character.skill_id_for_slot("skill_11")) +
		"document.documentElement.dataset.playerRuntimeSkill11=%s;" % JSON.stringify(str(player_runtime_skill_ids.get("skill_11", ""))) +
		"document.documentElement.dataset.playerRuntimeSkill11Type=%s;" % JSON.stringify(str(player_runtime_skill_types.get("skill_11", ""))) +
		"document.documentElement.dataset.playerRuntimeSkill11Source=%s;" % JSON.stringify(str(player_runtime_skill_sources.get("skill_11", ""))) +
		"document.documentElement.dataset.playerCharacterSkill12=%s;" % JSON.stringify(player_character.skill_id_for_slot("skill_12")) +
		"document.documentElement.dataset.playerRuntimeSkill12=%s;" % JSON.stringify(str(player_runtime_skill_ids.get("skill_12", ""))) +
		"document.documentElement.dataset.playerRuntimeSkill12Type=%s;" % JSON.stringify(str(player_runtime_skill_types.get("skill_12", ""))) +
		"document.documentElement.dataset.playerRuntimeSkill12Source=%s;" % JSON.stringify(str(player_runtime_skill_sources.get("skill_12", ""))) +
		"document.documentElement.dataset.playerCharacterSkill13=%s;" % JSON.stringify(player_character.skill_id_for_slot("skill_13")) +
		"document.documentElement.dataset.playerRuntimeSkill13=%s;" % JSON.stringify(str(player_runtime_skill_ids.get("skill_13", ""))) +
		"document.documentElement.dataset.playerRuntimeSkill13Type=%s;" % JSON.stringify(str(player_runtime_skill_types.get("skill_13", ""))) +
		"document.documentElement.dataset.playerRuntimeSkill13Source=%s;" % JSON.stringify(str(player_runtime_skill_sources.get("skill_13", "")))
	)
