...
const OPTIONAL_SKILL_SLOTS := ["skill_7", "skill_8", "skill_9", "skill_10", "skill_11"]
const SUPPORTED_SKILL_SLOTS := ["skill_1", "skill_2", "skill_3", "skill_4", "skill_5", "skill_6", "skill_7", "skill_8", "skill_9", "skill_10", "skill_11"]
